...
function Preloader() {
  const { setShowPreloader } = React.useContext(AppContext);

  const loadPreloader = () => {
    const $overlay = document.querySelector(`.${textObject.overlayClass}`);
    const $preloader = document.querySelector(`.${textObject.preloaderClass}`);
    const $title = document.querySelector(`.${textObject.preloaderTitleClass}`);
