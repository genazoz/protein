...
import {setMenuOpened} from "../../redux/slices/settingsSlice";

const Balls = React.lazy(() => import(/* webpackChunkName: "Balls" */ "../Balls"));
  ...
  return (
    <MenuEl isShow={menuOpened}>
      {window.innerWidth > 1200 && (
        <React.Suspense fallback={<div>Loading...</div>}><Balls isShow={menuOpened}/></React.Suspense>)}
      <Overlay
        className="overlay"
        width="100%"
        height="100%"
